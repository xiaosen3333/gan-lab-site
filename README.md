...
首页以“精选成果”连续展示 DisBack、MoWorld、Ink Restorer、《运河·生长·万象》、人工智能发展简史图谱与 Artist 1.0，末尾保留项目和论文入口。文化作品与其他成果使用同一层级；桌面采用名称、摘要、媒体三列对齐，窄屏按同一顺序堆叠，图片等比展示。合作伙伴保留在首页与交流与合作页，项目页不展示。项目正文聚焦产物与方法，署名区仅保留具体分工，底层署名数据继续用于成员关联。
